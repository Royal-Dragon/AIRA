...
const InputField = ({ activeSession, isThinking, onSendMessage }) => {
  ...
  return (
    <div className="mt-4 flex p-1 bg-[#2D3137] rounded-xl ">
      <input
        type="text"
        className="flex-1 p-3 bg-[#2D3137] text-amber-100   rounded-lg shadow-inner "
      ...
      />
      <button
        className={` bg-[#1E5BB2] text-white px-2 my-1 mr-1 flex items-center  rounded-xl  hover:bg-[#5888b6] disabled:bg-gray-400 disabled:cursor-not-allowed`}
        onClick={handleSend}
